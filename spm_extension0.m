...
% Last Modified by GUIDE v2.5 12-Aug-2016 13:25:15
...
%%    [onelinestructure, cellarraystructure] = cuixuFindTDstructure(coor');cuixuFindStructure(xyz', handles.DB);
    ...
    [onelinestructure, cellarraystructure] = cuixuFindStructure(coor, guiData.DB);
...
V.fname=fullfile('/home/JinT/tempData',[fname ext]);
